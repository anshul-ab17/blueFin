  ...
  categories: [
    {
      ...
      vol: "$1.82M",
      outcomes: [
        outcome("Argentina", 1, "NO"),
        outcome("Spain", 99, "YES"),
        outcome("Draw", 0, "NO"),
      ],
    },
    {
      ...
      vol: "$750K",
      outcomes: [
        outcome("Over 2.5", 0, "NO"),
        outcome("Under 2.5", 100, "YES"),
      ],
    },
    {
      id: "nextgoal",
      ...
      vol: "$420K",
      outcomes: [
        outcome("Argentina", 0, "NO"),
        outcome("Spain", 0, "NO"),
        outcome("No More Goals", 100, "YES"),
      ],
    },
    {
      id: "scorer",
      ...
      vol: "$640K",
      outcomes: [
        outcome("Lamine Yamal", 100, "YES"),
        outcome("Other / None", 0, "NO"),
      ],
    },
  ],
};
